...
/* Provided by api.c: I/O byte queues backed by JS. */
extern int  m1_io_read_byte(void);    /* -1 on EOF, otherwise 0..255 */
extern void m1_io_write_byte(int b);
...
execute_IO()
{
    ...
    case 236:           /* 236:I/O READ , DEVICE(0):CARD_READER */
        ...
        /* I/O is backed by JS-supplied byte queues; no file opens needed. */
        IO_CYCLE = IoRead;
        break;
